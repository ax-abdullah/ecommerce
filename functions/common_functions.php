    ...
    function view_details(){
      global $connection;
        ...
        if(isset($_GET['product_id'])){
          ...
          if(!isset($_GET['category'])){
            if(!isset($_GET['brand'])){
            $products_query = "SELECT * FROM `products` WHERE product_id=".$_GET['product_id']."";
              }else{
                $products_query = "SELECT * FROM `products` WHERE brand_id=".$_GET['brand'].""; 
              }
            }
            ...
            while($products_result = mysqli_fetch_assoc($result)){
              ...
              <div class='card'>
                  <img src='images/products/".$products_result["product_image1"]."' class='card-img-top' alt='".$products_result["product_image1"]."'>
                  <div class='card-body'>
                  <h5 class='card-title'>".$products_result['product_title']."</h5>
                  <p class='card-text'>".$products_result['product_description']."</p>
                  <a href='#' class='btn btn-info'> Add to cart</a>
          ...
          <div class='col-md-8'>
              ...
              <div class='row'>
                  ...
                  <div class='col-md-6'>
                    <img src='images/products/".$products_result["product_image2"]."' class='card-img-top' alt='".$products_result["product_image2"]."'>
                  </div>
                  <div class='col-md-6'>
                    <img src='images/products/".$products_result["product_image3"]."' class='card-img-top' alt='".$products_result["product_image3"]."'>
                  </div>
              </div>
          </div>
              ";
